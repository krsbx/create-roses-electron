...
When contributing to `create-roses-electron`, whether on GitHub or in other community spaces:

- Be respectful, civil, and open-minded.
- Before opening a new pull request, try searching through the [issue tracker](https://github.com/krsbx/create-roses-electron/issues) for known issues or fixes.
...
```bash
git clone https://github.com/<your-github-name>/create-roses-electron.git
```
...
Please a make PR to the [upstream](https://github.com/krsbx/create-roses-electron/) in the main branch.
